...
$resultado = mysqli_query($conexion, "SELECT idproveedor, nomproveedor, rucproveedor, dirproveedor, telproveedor, emailproveedor FROM Proveedores ORDER BY nomproveedor");
?>
<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
<title>Proveedores - Sistema de Facturación</title>
<style>
...
<div class="contenedor">
    ...
    <a class="btn btn-verde nuevo-btn" href="nuevo_proveedor.php">+ Nuevo Proveedor</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo escapar($fila['idproveedor']); ?></td>
                <td><?php echo escapar($fila['nomproveedor']); ?></td>
                <td><?php echo escapar($fila['rucproveedor']); ?></td>
                <td><?php echo escapar($fila['dirproveedor']); ?></td>
                <td><?php echo escapar($fila['telproveedor']); ?></td>
                <td><?php echo escapar($fila['emailproveedor']); ?></td>
                <td class="acciones">
                    <a class="btn btn-amarillo" href="modificar_proveedor.php?id=<?php echo urlencode($fila['idproveedor']); ?>">Modificar</a>
                    <a class="btn btn-rojo" href="confirmar_eliminar.php?entidad=proveedor&id=<?php echo urlencode($fila['idproveedor']); ?>">Eliminar</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
